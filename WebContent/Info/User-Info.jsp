...
<body>
	...
	<div class="info-member-container">
		...
		<p class="usermodify-msg" style="margin-left: 18%">
			<strong class="usermodify=mail"> testEmail@google.com </strong> "님의
			...
			<table class="info-UserModify-table">
				<tbody>
					...
					<tr>
						...
						<td><input type="password" id="testpw"></td>
					</tr>
		...
		<div class="info-usermodify-btn">
			<button type="submit" class="info-usermodify-submit"
				onclick="location.href='User-InfoUp.jsp'">확인</button>
			<button type="button" class="info-usermodify-cancel">취소</button>
		</div>
