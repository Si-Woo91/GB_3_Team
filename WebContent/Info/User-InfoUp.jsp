	...
	<div class="ifup-body-wrap">
										...
										<tbody>
											<tr>
												...
												<td><input type="password"
													class="ifup-usermodify-currentpassword-tf">
												<div class="member__input-guide-area"></div></td>
											</tr>
											<tr>
												<th>새 비밀번호</th>
												<td><input type="password"
													class="ifup-usermodify-newpassword-tf">
												<div class="member__input-guide-area"></div></td>
											</tr>
											<tr>
												<th>비밀번호 다시 입력</th>
												<td><input type="password"
													class="ifup-usermodify-newpassword-confirm-tf">
												<div class="member__input-guide-area"></div></td>
											</tr>
											<tr>
												<td></td>
												<td>
													<button type="button"
														class="ifup-usermodify-password-submit"
														onclick="PWsendit()">비밀번호 변경</button>
												</td>
											</tr>
										</tbody>
									</table>
		...
		<div class="ifup-usermodify-secession">
			탈퇴를 원하시면 우측의 회원탈퇴 버튼을 눌러주세요. <a class="ifup-usermodify-secession-btn"
				href="secession.jsp">회원탈퇴</a>
		</div>

		<div class="ifup-usermodify-foot">
			<button type="button" class="ifup-usermodify-cancel"
				onclick="location.href='../lobby/Mypage.jsp'">나가기</button>
		</div>
	</div>
