...
<body>
	...
	<div>
		...
		<div class="login_search">
			<a href="#" onclick="location.href='../main/main.jsp'" class=logo><img
				src=../img/logo.png></a>
			<!-- 로그인, 로그아웃, 장바구니, 고객센터 -->
			<ul class=nav1>
				...
				<c:choose>
					<c:when test="${sessionId eq null}">
						<li class=login><a id="log_change"
							href="${pageContext.request.contextPath}/IDPW/login.jsp">로그인</a>
						</li>
					</c:when>
					<c:otherwise>
						<li class=login><a
							href="${pageContext.request.contextPath}/lobby/mypage.spm">마이페이지</a>
						</li>
						<li class=login>${sessionId}님환영합니다.&nbsp;&nbsp;&nbsp;<a
							href="#"
			...
			<div class="search1">
				<form
					action="${pageContext.request.contextPath}/goods/SearchGoods.spm"
					method="post" name="searchForm">
					<input placeholder="Search" class='search_main' name="searchtext">
					<a class="btn" href="javascript:document.searchForm.submit()"
						role="button"> <img
			...
			<div class="category">
				<div class=nav2>
					<ul>
						<li><a
							href="${pageContext.request.contextPath }/goods/goodsList.goods?gCatg=냉장고"
							class="a">냉장고</a>
							<ul>
						...
						<li><a
							href="${pageContext.request.contextPath }/goods/goodsList.goods?gCatg=세탁기"
							class="a">세탁기</a>
							<ul>
								<li><a href="상품페이지 경로" style="color: blue;">SAMSUNG</a></li>
								<li><a href="상품페이지 경로" style="color: red;">LG</a></li>
						...
						<li><a
							href="${pageContext.request.contextPath }/goods/goodsList.goods?gCatg=TV"
							class="a">TV</a>
							<ul>
								<li><a href="상품페이지 경로" style="color: blue;">SAMSUNG</a></li>
								<li><a href="상품페이지 경로" style="color: red;">LG</a></li>
						...
						<li><a
							href="${pageContext.request.contextPath }/goods/goodsList.goods?gCatg=에어컨"
							class="a">에어컨</a>
							<ul>
								<li><a href="상품페이지 경로" style="color: blue;">SAMSUNG</a></li>
								<li><a href="상품페이지 경로" style="color: red;">LG</a></li>
						...
						<li><a
							href="${pageContext.request.contextPath }/goods/goodsList.goods?gCatg=컴퓨터"
							class="a">컴퓨터</a>
							<ul>
								<li><a href="상품페이지 경로" style="color: blue;">SAMSUNG</a></li>
								<li><a href="상품페이지 경로" style="color: red;">LG</a></li>
