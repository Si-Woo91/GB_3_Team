...
<body>
	...
	<div class="order" style="padding-top: 230px;">
		<h3 class="order-order-h3"
			style="width: 150px; text-align: center; font-weight: bold;">주문
			목록</h3>
	</div>
	...
	<table class="order-paging" style="border: 0px; width: 900px;">
		<tr align="center" valign="middle">
			<td><c:if test="${nowPage > 1 }">
					<a
						href="${pageContext.request.contextPath}/OrderList/OrderList.spm?page=${nowPage-1}">[&lt;]</a>
					...
					<c:choose>
						...
						<c:otherwise>
							<a
								href="${pageContext.request.contextPath}/OrderList/OrderList.spm?page=${i}">[${i }]</a>
						</c:otherwise>
					</c:choose>
