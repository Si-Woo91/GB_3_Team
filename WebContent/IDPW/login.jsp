...
<html>
<head>
<link href="${pageContext.request.contextPath }../css/id.css"
...
<body>
	...
	<form action="${pageContext.request.contextPath }/main/main.spm"
		...
		<div class="wrap">
			<div class="login">
				...
				<br> <br> <input type="button" id="login-btn" class="btn"
