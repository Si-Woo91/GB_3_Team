...
<body id="payment">
	<section id='checkout'>
		...
		<table id="pay_tb">
			...
			<thead>
				<tr>
					<td class="real_top" style="border-right: 20px solid transparent;"><h3
							id="title1">배송지정보</h3></td>
			...
			<tr>
				<td style="border-right: 20px solid transparent">
					<table id="delivery_tb" class="sub_tb">
						...
						%>
							<td>받는분</td>
							<td><span style="color: red; font-weight: bold">*</span> <input
								type="text" id="receiver" value="<%= name %>"
								style="width: 300px"></td>
						</tr>
						<tr>
							<td>연락처1</td>
							<td><span style="color: red; font-weight: bold">*</span> <input
								type="number" id="phone1" value="<%= phone.substring(0,3) %>"
								style="width: 80px"> - <input type="number" id="phone2"
								value="<%= phone.substring(3,7)  %>" style="width: 80px">
								- <input type="number" id="phone3"
								value="<%= phone.substring(7,11)  %>" style="width: 80px">
							</td>
						</tr>
						<tr>
							<td>연락처2</td>
							<td><span style="color: transparent; font-weight: bold">*</span>
								...
								type="number" style="width: 80px"> - <input
						...
						<tr>
							...
							<td><span style="color: red; font-weight: bold">*</span> <input
								...
								id="address_button" onclick="sample6_execDaumPostcode()"
						...
						<tr>
							...
							<td><span style="color: red; font-weight: bold">*
									필수작성란</span> <!-- 								<span style="color:transparent; font-weight:bold">*</span> -->
				...
				<td rowspan="3" style="text-align: right">
					...
					<h2 id="margin_fix1">
						최종 결제금액 :
						<%= df.format(checkoutSum+shippingCost)%>
						원
					</h2>
					<h3 id="margin_fix2">
						상품금액 :
						<%= df.format(checkoutSum) %>
						원
					</h3>
					<h3 id="margin_fix3">
						배송비 :
						<%= df.format(shippingCost) %>
						원
					</h3> <br> <input type="button" id="pay_button" value="결제하기"
					onclick="checkoutnpay();">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="border-right: 20px solid transparent; height: 150px">
					...
					<table id="creditcard_tb" class="sub_tb">
						...
						<tr>
							<td>카드종류</td>
							<td><select name="card" style="width: 110px">
						...
						<tr>
							<td>할부종류</td>
							<td><select name="installment" style="width: 110px">
						...
						<tr>
							<td colspan="2">
								<ul id="explain1">
									<li>&lt;카카오뱅크 체크카드 혜택&gt;</li>
									<li>3만원 이상 결제 시 <span style="color: #F27370">2천원
											캐시백</span></li>
									<li>온/오프라인에서 <span style="color: #F27370">월 1회 사용
											가능</span></li>
					...
					<table id="nobank_tb" class="sub_tb">
						...
						<tr>
							<td>은행명</td>
							<td><select name="bank" style="width: 100px">
