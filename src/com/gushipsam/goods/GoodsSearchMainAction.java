...
public class GoodsSearchMainAction implements Action{
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) {
		...
		if(searchtext_str ==null || searchtext_str.equals("")) {
			req.setAttribute("goodsList", null);
			...
			for (int i = 0; i < searchtext.length; i++) {
				...
				if(t.equalsIgnoreCase("samsung"))  searchtext[i] = "삼성";
				if(t.equalsIgnoreCase("apple")) searchtext[i] = "애플";
				if(t.equalsIgnoreCase("winia")) searchtext[i] = "위니아";
				if(t.equalsIgnoreCase("엘지")) searchtext[i] = "lg";
				if(t.equalsIgnoreCase("ac")) searchtext[i] = "에어컨";
				if(t.equalsIgnoreCase("갤럭시")) searchtext[i] = "galaxy";
				if(t.equalsIgnoreCase("갤럭시북")) searchtext[i] = "galaxy book";
				if(t.equalsIgnoreCase("맥북")) searchtext[i] = "macbook";
				if(t.equalsIgnoreCase("울트라기어")) searchtext[i] = "ultragear";
				if(t.equalsIgnoreCase("울트라")) searchtext[i] = "ultra";
				if(t.equalsIgnoreCase("비스포크")) searchtext[i] = "bespoke";
				if(t.equalsIgnoreCase("그램")) searchtext[i] = "gram";
			}
